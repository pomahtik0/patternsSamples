...
// Висновок: як на мене, від звичайної фабрики мало відрізняється, суть залишається не змінною: використання інкапсуляції для класів що виходять з фабрики. Якщо, прочитати теорію, то вся суть в отриманні "сімейства схожих продуктів".
